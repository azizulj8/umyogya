<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<?=base_url()?>assets/global/img/favicon.ico" /> </head>
    <!-- END HEAD -->
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    <img class="login-logo login-6" src="<?=base_url('assets/global/img/logo_umy.png')?>" />
                    <div class="login-content">
                        <h1>BUJS Admin Login</h1>
                        <form action="<?=base_url('index.php/login/login')?>" class="login-form" method="post">
                            <?php
...
<!--                                     <div class="forgot-password">
                                    ...
                                    <a href="<?=base_url()?>" class="btn blue">Back</a>
