...
<link href="<?=base_url()?>assets/admin/css/layout.css" rel="stylesheet" type="text/css"/>
<link id="style_color" href="<?=base_url()?>assets/admin/css/themes/grey.css" rel="stylesheet" type="text/css"/>
<link href="<?=base_url()?>assets/admin/css/custom.css" rel="stylesheet" type="text/css"/> -->

<link href="<?=base_url()?>assets/global/css/components.css" id="style_components" rel="stylesheet" type="text/css"/>
<link href="<?=base_url()?>assets/global/css/plugins.css" rel="stylesheet" type="text/css"/>
<link href="<?=base_url()?>assets/admin/css/layout.css" rel="stylesheet" type="text/css"/>
<link href="<?=base_url()?>assets/admin/css/themes/blue.css" rel="stylesheet" type="text/css" id="style_color"/>
<link href="<?=base_url()?>assets/admin/css/custom.css" rel="stylesheet" type="text/css"/>
